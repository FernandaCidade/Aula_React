...
function VisualizarServico() {
    ...
    const [visualizarServs, setVisualizarServs] = useState<any[]>([

       
    ]);

    const [servicos, setServicos] = useState<any[]>(visualizarServs);
            ...
            <div className="container">
                ...
                <div className="servico">
                    ...
                    <div className="techs">
                        ...
                        <ul>
                            {servicos.map((visualizarServs: any, index: number) => {
                                return <li key={index}>
                                    <ListaServicos
                                    id={servicos.id}
                                  />
