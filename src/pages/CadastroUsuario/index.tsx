...
function CadastroUsuario() {
    ...
    function verificarCampoUpload(event: any){ //vai verificar o que tem dentro do input de arquivo
    ...
    function cadastrarUsuario(event: any){
        ...
        formData.append("nome", nome) //tudo que for append é adicionar
        ...
        api.post("users", formData).then((response) =>{ //vai pegar os usuario de formdata, mandar para api em users para cadatrar novo usuário
                    ...
                    <form onSubmit={cadastrarUsuario }  className="cad_formulario" method="POST">
                        ...
                        <div className="cad_box_input">
                            ...
                            <input
                                type="file"
                                id="foto"
                                onChange={verificarCampoUpload} //toda vez q inserir ou alterar ou retirar imagem, vai chamar a funcao atualiza
                                required
                            />
                        </div>
